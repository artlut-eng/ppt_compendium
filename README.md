...
2. Faça o **briefing** com [`00-guia/briefing.md`](00-guia/briefing.md): mensagem central, objetivo, nível de exposição (interno, interáreas, externo) e identidade visual (logotipo, cores). Modo direto ou guiado: [`00-guia/prompt-base-para-agentes.md`](00-guia/prompt-base-para-agentes.md).
...
8. Valide com os **checklists** de [`07-checklists/`](07-checklists/) e o validador `06-codigo/python-pptx/audit_deck.py`; separe fatos, inferências e recomendações ([`00-guia/fatos-inferencias-recomendacoes.md`](00-guia/fatos-inferencias-recomendacoes.md)).
...
| `04-modelos-de-slides/` | 19 modelos de slide (capa, KPI, tabela, timeline, takeaways, barras de progresso...) + campos comuns (kicker, callout, cabeçalho, logotipo) com anatomia e coordenadas |
| `05-artefatos-visuais/` | Paletas em JSON, guia de escolha de gráficos, ícones e formas, logotipo e marca (com placeholders) |
| `06-codigo/` | Bibliotecas base em python-pptx e PptxGenJS, gerador a partir da spec, renderizador de miniaturas (PowerPoint) e validador automático de decks |
