...
4. Pick the **deck type** (`03-tipos-de-apresentacao/`): 16 types, each with a slide-by-slide structure and a JSON spec example.
...
| `03-tipos-de-apresentacao/` | Deck types: project status, financial, sales, operational review, strategic plan, business case, proposal, pitch, kickoff, lessons learned, training, all-hands, process efficiency, portfolio review, KPI review, progress report |
